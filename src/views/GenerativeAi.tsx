        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="relative">
                ...
                <button 
                    ...
                    className={!isGenerating ? `cursor-pointer absolute top-1/2 right-5 transform -translate-x-1/2 -translate-y-1/2` : 
                        `cursor-not-allowed absolute top-1/2 right-5 transform -translate-x-1/2 -translate-y-1/2`}
                >
